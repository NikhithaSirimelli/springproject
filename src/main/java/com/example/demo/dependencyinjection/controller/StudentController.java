...
import com.example.demo.dependencyinjection.service.StudentService;
...
public class StudentController {
...

	{
		...
		studentService.add(new Student("1n3", 3, "Nikhitha", "Sirimelli", "India", "Near post Office", new Date()));
	}
